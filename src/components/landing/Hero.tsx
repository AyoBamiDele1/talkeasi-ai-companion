...
const Hero = ({ onStartTrial }: HeroProps) => {
  return (
    <header className="relative px-6 pt-10 md:pt-14">
      <div
        className="mx-auto max-w-6xl overflow-hidden rounded-[28px] border border-border px-6 py-14 md:px-14 md:py-16"
        style={{
